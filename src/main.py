...
python ../../src/main.py --action=execute --model_id=test --csv=../../data/org/25-08-21_27.csv --calibration=linear --sensors 0 1 2 --reference 3 --start_time_hour 3 --start_time_minute 0 --end_time_hour 20 --end_time_minute 0 --latitude 52.22977 --longtitude 21.01178 --timezone=Europe/Warsaw --altitude 170 --name=Warsaw --frequency=1min --albedo 0.25 --surface_tilt 0 --surface_azimuth 180 --project_dir ./ --calibration_metrics_dir ../update/logs/25-08-21_27
'''
